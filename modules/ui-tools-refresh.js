...
function ensureStyles(){
  ...
  style.textContent=`
    ...
    .tools-search-wrap{position:relative;flex:1;min-width:240px}.tools-search-wrap input{width:100%;padding:12px 42px 12px 12px;border:1px solid var(--l);border-radius:14px;background:#fff;box-shadow:0 6px 20px #1b3a7620}
